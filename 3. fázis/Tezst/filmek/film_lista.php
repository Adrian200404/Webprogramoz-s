...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- CSS stílusok -->
...
<body>
    ...
    <div class="container">
        ...
        <form action="film_lista.php" method="post" style="margin-bottom: 20px;">
        ...
        <ul class="film-list">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Értékelési űrlap
                    echo '<form action="film_lista.php" method="post" class="film-ertekeles">';
                    ...
                    echo '<form action="film_lista.php" method="post">';
                    echo '<input type="hidden" name="film_id" value="' . $row['id'] . '">';
                    ...
                    echo '<a class="my-button" href="film_szerkesztese.php?id=' . $row['id'] . '">Szerkesztés</a>';
                    echo '</div>';
        ...
        <br>
        <a href="film_hozaadasa.php" class="my-button">Új film hozzáadása</a>
